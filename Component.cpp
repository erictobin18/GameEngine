...
PhysicsComponent::PhysicsComponent(gMath::componentID cid, gMath::entityID eid, gMath::state s): Component(cid, eid), entityState(s),gravityEnabled(true),terrainEnabled(true),mouseControl(false),onGround(false)
{
